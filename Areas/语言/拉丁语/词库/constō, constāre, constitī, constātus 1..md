...
# constō, constāre, constitī, constātus 1.

## 基本信息
- **语言**: 拉丁语
- **词性**: v. intr. (第一变位); 部分义项可带 predicative dat.
- **词源**: *con-* + *stō* (to stand); 字面义为"站在一起/站稳" → 固定、确知
...
4. to cost, come to (价格; + 属格/夺格)
   a. *magnō cōnstat* — 代价高昂

## 关联词汇
- [[stō, stāre, stetī, status 1.]] (词根)
- [[cōnstāns, -antis]] (坚定的、始终如一的——现在分词)
- [[cōnstantia, -ae f.]] (坚定、恒常)
- [[cōnstat (impers.)]] (同源非人称用法)

## 复习提示
- 本课用法为非人称义（cōnstābat + acc. + inf.），Caesar 高频句式
- 区别于 *cōnsistō* (停止、立足) —— 后者有完成时 *cōnstitī*，易混
